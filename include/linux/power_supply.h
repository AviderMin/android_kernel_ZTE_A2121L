...
struct power_supply_battery_info {
	...
	int charge_full_design2_uah;	    /* microAmp-hours */
	...
	int factory_internal_resistance2_uohm;   /* microOhms */
	int ocv_temp[POWER_SUPPLY_OCV_TEMP_MAX];/* celsius */
	struct power_supply_battery_ocv_table *ocv_table[POWER_SUPPLY_OCV_TEMP_MAX];
	struct power_supply_battery_ocv_table *ocv_table2[POWER_SUPPLY_OCV_TEMP_MAX];
	int ocv_table_size[POWER_SUPPLY_OCV_TEMP_MAX];
	int ocv_table2_size[POWER_SUPPLY_OCV_TEMP_MAX];
