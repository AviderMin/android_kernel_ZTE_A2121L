...
/* light sensor calibrate min value is 400lux */
#define LIGHT_SENSOR_MIN_VALUE  400
/* light sensor calibrate max value is 2000lux */
#define LIGHT_SENSOR_MAX_VALUE  2000
